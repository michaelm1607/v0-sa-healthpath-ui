...
export const scenarios: Scenario[] = [
  {
    ...
    riskFactors: [
      ...
      { id: "rf2", label: "Unmanaged diabetes", correct: true },
      { id: "rf3", label: "Social isolation", correct: true },
      { id: "rf4", label: "Medication non-adherence risk", correct: true },
      { id: "rf5", label: "Food insecurity", correct: false },
      { id: "rf6", label: "Housing instability", correct: false },
    ],
    correctUrgency: "Immediate",
    referralPathways: [
      { id: "rp1", label: "SA Metro Health – Heat Emergency Line", category: "Emergency Services", correct: true },
      { id: "rp2", label: "CPS Energy Cooling Assistance Program", category: "Utility Assistance", correct: true },
      { id: "rp3", label: "SA Area Agency on Aging – Wellness Check", category: "Senior Services", correct: true },
      { id: "rp4", label: "WIC Nutrition Services", category: "Nutrition", correct: false },
      { id: "rp5", label: "Goodwill Job Training Center", category: "Employment", correct: false },
    ],
    feedback: {
      recognized: [
      ...
      strongerPathway:
        "A same-day wellness check through SA Area Agency on Aging coordinated with Metro Health Heat Emergency resources and bilingual outreach.",
      whyItMatters:
        "Heat stroke in elderly diabetics can escalate to organ failure within hours. Immediate intervention and cooling access are life-saving.",
    },
    categoryScores: {
      riskRecognition: 85,
      urgencyJudgment: 90,
      referralFit: 80,
      communicationLanguage: 55,
      safetyAwareness: 88,
    },
  },
  {
