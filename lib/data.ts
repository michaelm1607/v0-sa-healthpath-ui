...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    riskFactors: [
      ...
      { id: "rf4", label: "Uninsured – Emergency Medicaid eligibility not yet established", correct: true },
      { id: "rf5", label: "Domestic violence screening needed", correct: false },
    ...
    referralPathways: [
      ...
      { id: "rp5", label: "Emergency Medicaid – Pregnancy Coverage Enrollment", category: "Benefits", correct: true },
      { id: "rp6", label: "Goodwill Job Placement", category: "Employment", correct: false },
    ],
    feedback: {
      recognized: [
